...
local wz = {};
local Fz = {
    ["Border Color"] = Color3.fromRGB(255, 0, 0),           -- Changed from (120, 50, 200) to Red
    ["Click Effect Color"] = Color3.fromRGB(230, 230, 230),
    ["Setting Icon Color"] = Color3.fromRGB(230, 230, 230),
    ["Logo Image"] = "rbxassetid://131142457556232",
    ["Search Icon Color"] = Color3.fromRGB(255, 255, 255),
    ["Search Icon Highlight Color"] = Color3.fromRGB(255, 0, 0),  -- Changed to Red
    ...
    ["Title Text Color"] = Color3.fromRGB(255, 0, 0),        -- Changed from (120, 50, 200) to Red
    ...
    ["Background Image"] = "",
    ["Page Selected Color"] = Color3.fromRGB(255, 0, 0),     -- Changed from (120, 50, 200) to Red
    ["Section Text Color"] = Color3.fromRGB(255, 0, 0),     -- Changed from (120, 50, 200) to Red
    ["Section Underline Color"] = Color3.fromRGB(255, 0, 0),-- Changed from (120, 50, 200) to Red
    ["Toggle Border Color"] = Color3.fromRGB(255, 0, 0),    -- Changed from (120, 50, 200) to Red
    ...
    ["Dropdown Selected Color"] = Color3.fromRGB(255, 0, 0),-- Changed from (120, 50, 200) to Red
    ["Dropdown Selected Check Color"] = Color3.fromRGB(255, 0, 0),-- Changed from (120, 50, 200) to Red
    ["Textbox Highlight Color"] = Color3.fromRGB(255, 0, 0),-- Changed from (120, 50, 200) to Red
    ["Box Highlight Color"] = Color3.fromRGB(255, 0, 0),    -- Changed from (120, 50, 200) to Red
    ["Slider Line Color"] = Color3.fromRGB(45, 22, 67),
    ["Slider Highlight Color"] = Color3.fromRGB(255, 0, 0), -- Changed from (120, 50, 200) to Red
...
Az.Position = UDim2.new(1, -100, 0.5, -15);
...
gz.Image = "rbxassetid://95007609816130";
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">KFC.Hook</font> " .. dz.TitleNameNoti));
		...
		I.Image = "rbxassetid://95007609816130";
...
function Kz.CreateMain(Y)
	...
	r.Image = "rbxassetid://95007609816130";
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">KFC.Hook </font> : Blox Fruits");
	...
	y.Image = "rbxassetid://95007609816130";
	y.BackgroundTransparency = 1;
	y.ImageTransparency = 1.0;
	...
	F.Position = UDim2.new(0, 5, 0, dz.T1 and 5 or 0);
	F.Size = UDim2.new(0, dz.T1 and 30 or 25, 0, dz.T1 and 15 or 25);
	F.Image = "rbxassetid://95007609816130";
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">BoronZ </font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
